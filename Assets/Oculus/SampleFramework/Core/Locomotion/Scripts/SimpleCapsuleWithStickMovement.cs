...
public class SimpleCapsuleWithStickMovement : MonoBehaviour
{
	...
	[SerializeField] private GameObject body; // player body
	...
	void SnapTurn()
	{
			...
			(RotationEitherThumbstick && OVRInput.Get(OVRInput.Button.PrimaryThumbstickLeft)))
		{
			if (ReadyToSnapTurn)
			{
				...
				body.GetComponent<BodyBehavior>().orientation = transform.rotation; // update orientation of body to match snap turn
			}
		}
