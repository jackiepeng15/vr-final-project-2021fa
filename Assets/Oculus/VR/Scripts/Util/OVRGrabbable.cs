...
public class OVRGrabbable : MonoBehaviour
{
    ...
    [SerializeField] protected Transform m_snapOffsetRight; // snap offset for right controller grab
    [SerializeField] protected Transform m_snapOffsetLeft; // snap offset for left controller grab
	...
	virtual public void GrabEnd(Vector3 linearVelocity, Vector3 angularVelocity, Vector3 cross)
    {
        ...
        Vector3 fullThrowVelocity = 2 * (linearVelocity + cross);
