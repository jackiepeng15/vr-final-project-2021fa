...
public class OVRGrabber : MonoBehaviour
{
    ...
    protected void GrabbableRelease(Vector3 linearVelocity, Vector3 angularVelocity, Vector3 controllerVelocityCross)
    {
        m_grabbedObj.GrabEnd(linearVelocity, angularVelocity, controllerVelocityCross);
